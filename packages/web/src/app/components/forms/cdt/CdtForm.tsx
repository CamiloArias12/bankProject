...
export function CdtForm({
 onClickAccept,onClickCancel,handleCdt,cdt,handleCdtSelect,clients
}: {
   onClickAccept:any,onClickCancel:any,cdt:any,handleCdt:any,handleCdtSelect:any,clients?:any
}) {
