...
export function PaymentForm({
 onClickAccept,onClickCancel,handlePayment,payment,handlePaymentSelect,clients,index
}: {
   onClickAccept:any,onClickCancel:any,payment:any,handlePayment:any,handlePaymentSelect:any,index:number,clients?:any
}) {
