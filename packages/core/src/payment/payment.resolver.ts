...
export class PaymentResolver {
  ...
  @Mutation(() => Boolean)
  async createPaymentCredit(@Args('createPaymentInput') createPaymentInput: CreatePaymentInput) {
    return this.paymentService.createPaymentCredit(createPaymentInput);
  }
  @Mutation(() => Boolean)
  async createPaymentCdt(@Args('createPaymentInput') createPaymentInput: CreatePaymentInput) {
    return this.paymentService.createPaymentCdt(createPaymentInput);
  }
  
  @Mutation(() => Boolean)
  async createPaymentAccount(@Args('createPaymentInput') createPaymentInput: CreatePaymentInput) {
