...
let InstallmentsService = class InstallmentsService {
    constructor(installmentRepository, dataSource) {
        this.installmentRepository = installmentRepository;
        this.dataSource = dataSource;
    }
    async finOneByCreditAndNumberInstallment(idCredit, numberInstallment) {
        return await this.installmentRepository.findOne({ where: { id_credit: idCredit,
                installmentNumber: numberInstallment
            } });
    }
    async updateState(installmentNumber, credit, state) {
